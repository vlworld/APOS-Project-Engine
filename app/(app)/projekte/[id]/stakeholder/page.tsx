...
import { Users, Plus, X, Mail, Phone, Building2, MessageSquare } from "lucide-react";
...
export default function StakeholderPage() {
  ...
  async function load() {
    const res = await fetch(`/api/projekte/${projectId}/stakeholder`);
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-base font-semibold text-gray-900">Stakeholder</h2>
          <p className="text-sm text-gray-500 mt-0.5">{stakeholders.length} Stakeholder</p>
        </div>
        <button
        ...
        >
          <Plus size={15} /> Neuer Stakeholder
        </button>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-24 text-center">
          ...
          <h3 className="text-base font-semibold text-gray-900 mb-1">Noch keine Stakeholder</h3>
          <p className="text-sm text-gray-500 max-w-xs mb-5">Erfassen Sie die wichtigsten Projektbeteiligten.</p>
